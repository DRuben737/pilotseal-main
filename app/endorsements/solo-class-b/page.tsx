...
export default function SoloClassBPage() {
  const endorsementText = `I certify that [Student Name] has received the required training of 14 CFR § 61.95(a). I have determined they are proficient to conduct solo flights in [Name of Class B] airspace. [List any applicable conditions or limitations.]
        ...
        <section className="hero-panel hero-endorsement overflow-hidden px-6 py-7 sm:px-8 sm:py-9">
          <div className="reading-rail">
            ...
            <p className="copy-muted mt-3 max-w-2xl leading-7">
              This is the FAA required logbook endorsement under 14 CFR § 61.95(a) that authorizes a student pilot to conduct solo flights within Class B airspace.
            </p>
          </div>
        </section>
          ...
          <div className="reading-rail max-w-2xl">
            ...
            <ul className="space-y-4">
              <li className="reference-item">
                <p className="font-semibold text-[var(--foreground)]">14 CFR § 61.95(a)</p>
        ...
        <section className="cta-section section-panel px-6 py-8 sm:px-8 sm:py-10 bg-[var(--surface-accent-soft)]">
          <div className="reading-rail max-w-2xl text-center">
            ...
            <p className="copy-muted mb-6 leading-7">
              PilotSeal ensures the correct Class B airspace name, verifies 14 CFR § 61.95(a) compliance, and includes all required limitations.
            </p>
            <Link
              href="/tools/endorsement-generator?type=solo-class-b"
