        ...
        <section className="hero-panel hero-endorsement overflow-hidden px-6 py-7 sm:px-8 sm:py-9">
          <div className="reading-rail">
            ...
            <p className="copy-muted mt-3 max-w-2xl leading-7">
              This is the FAA required logbook endorsement under 14 CFR § 61.39(a)(6)(i) and (ii) that certifies recent practical-test preparation and readiness for the practical test.
            </p>
          </div>
        </section>
          ...
          <div className="reading-rail max-w-2xl">
            ...
            <ul className="space-y-4">
              <li className="reference-item">
                <p className="font-semibold text-[var(--foreground)]">14 CFR § 61.39(a)(6)(i) and (ii)</p>
