...
console.log('17 schedule draft assertions passed (middle/first/last moves, spacing, other days, blocks, earlier moves, overlap, cancellation, rebase, undo and net changes).');
